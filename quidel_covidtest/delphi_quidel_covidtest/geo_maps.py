...
class GeoMaps:
    """Class to map zips to other geographic resolutions."""
    
    def zip_to_msa(self, data, map_df):
    ...
    def zip_to_hrr(self, data, map_df):
        ...
        data["hrrnum"] = data["hrrnum"].apply(lambda x: int(x))
    
        return data, "hrrnum"

    def zip_to_county(self, data, map_df):
    ...
    def zip_to_state(self, data, map_df):

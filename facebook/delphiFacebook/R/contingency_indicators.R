...
get_aggs <- function() {
  ...
  indicators <- tribble(
    ...
    # vaccine timing
    "pct_vaccine_timing_weeks", "v_vaccine_timing_weeks", compute_binary_response, jeffreys_binary,
    "pct_vaccine_timing_onemonth", "v_vaccine_timing_onemonth", compute_binary_response, jeffreys_binary,
    "pct_vaccine_timing_threemonths", "v_vaccine_timing_threemonths", compute_binary_response, jeffreys_binary,
    "pct_vaccine_timing_sixmonths", "v_vaccine_timing_sixmonths", compute_binary_response, jeffreys_binary,
    "pct_vaccine_timing_morethansix", "v_vaccine_timing_morethansix", compute_binary_response, jeffreys_binary,
    "pct_vaccine_timing_dontknow", "v_vaccine_timing_dontknow", compute_binary_response, jeffreys_binary,

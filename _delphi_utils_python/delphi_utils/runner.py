...
def run_indicator_pipeline(indicator_fn:  Callable[[Params], None],
    ...
    #Logging - Starting Indicator
        logger.info("Started with covidcast-indicators", indicator_name=ind_name, current_version=current_version)
    else:
        logger.info("Started without version.cfg", indicator_name=ind_name)

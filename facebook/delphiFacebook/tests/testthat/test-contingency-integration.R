### This test file relies on `setup-run.R` to run the pipeline. This test checks
### the configuration listed in `params-contingency-test.json`, which loads
### `input/responses.csv`, a small selected subset of test responses.

context("Testing the run_contingency_tables function on test data")

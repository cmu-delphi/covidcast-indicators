...
def indicator_list = ["backfill_corrections", "changehc", "claims_hosp", "google_symptoms", "nchs_mortality", "quidel_covidtest", "sir_complainsalot", "doctor_visits", "nwss_wastewater", "nssp"]

...
read_params <- function(path = "params.json") {
  ...
  if (params$end_date == "current") {
    ...
    date_range = get_range_prev_full_period(params$end_date, params$aggregate_range)
  }
...
set_human_readable_colnames <- function(input_data) {
  ...
  map_old_new_names <- list(S1 = "consent",
                            A1_1 = "hh_fever",
                            A1_2 = "hh_sore_throat",
                            A1_3 = "hh_cough",
                            ...
                            A4 = "cmnty_num_sick",
                            B2 = "symptoms",
                            B2_14_TEXT = "symptoms_other",
                            B2c = "unusual_symptoms",
                            B2c_14_TEXT = "unusual_symptoms_other",
                            B2b = "days_unusual_symptoms",
                            B3 = "took_temp",
                            Q40 = "highest_temp_f",
                            B4 = "cough_mucus",
                            B5 = "tested_current_illness",
                            B6 = "hospital",
                            B7 = "medical_care",
                            B8 = "tested_ever",
                            B10 = "tested_14d",
                            B10a = "tested_pos_14d",
                            B10b = "reasons_tested_14d",
                            B12 = "wanted_test_14d",
                            B12a = "reasons_not_tested_14d",
                            B11 = "tested_pos_ever",
                            C1 = "comorbidities",
                            C2 = "flu_shot",
                            C3 = "worked_outside_home_5d",
                            C4 = "worked_healthcare_5d",
                            C5 = "worked_nursing_home_5d",
                            C7 = "social_avoidance",
                            C13 = "trips_outside_home",
                            C13a = "mask_outside_home",
                            C10_1_1 = "contact_num_work",
                            C10_2_1 = "contact_num_shopping",
                            C10_3_1 = "contact_num_social",
                            C10_4_1 = "contact_num_other",
                            C14 = "mask_public",
                            C15 = "financial_worry",
                            C6 = "state_travel",
                            C11 = "contact_tested_pos",
                            C12 = "contact_tested_pos_hh",
                            C8_1 = "anxiety",
                            C8_2 = "depression",
                            C8_3 = "isolation",
                            C9 = "worried_family_ill",
                            D1 = "gender",
                            D1_4_TEXT = "gender_other",
                            D1b = "pregnant",
                            D2 = "age",
                            D3 = "hh_num_children", # Wave 1, etc versions of A5
                            D4 = "hh_num_adults_not_self",
                            D5 = "hh_num_seniors_not_self",
                            D6 = "hispanic",
                            D7 = "race",
                            D8 = "education",
                            D9 = "worked_4w",
                            D10 = "worked_outside_home_4w",
                            Q36 = "financial_threat",
                            Q64 = "occupational_group",
                            Q65 = "job_type_cmnty_social",
                            Q66 = "job_type_education",
                            Q67 = "job_type_arts_media",
                            Q68 = "job_type_healthcare",
                            Q69 = "job_type_healthcare_support",
                            Q70 = "job_type_protective",
                            Q71 = "job_type_food",
                            Q72 = "job_type_maintenance",
                            Q73 = "job_type_personal_care",
                            Q74 = "job_type_sales",
                            Q75 = "job_type_admin",
                            Q76 = "job_type_construction",
                            Q77 = "job_type_repair",
                            Q78 = "job_type_production",
                            Q79 = "job_type_transport",
                            Q80 = "job_type_other"
                            )
...
aggregate_aggs <- function(df, aggregations, cw_list, params) {
  ...
  #### TODO: filter down to range of days in agg period

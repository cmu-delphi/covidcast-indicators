...
FIPS_MSA_OUT_FILE = "fips_msa_cross_2020.csv"
ZIP_CODE_FILE = "02_20_uszips.csv"
ZIP_FIPS_OUT_FILE = "zip_fips_cross_2020.csv"
FIPS_CODES = "fips_codes.xls"
...
def proc_zip_fips():
    ...
    zip_reduced.to_csv(ZIP_FIPS_OUT_FILE, index=False)
    ...
    state_df.to_csv(STATE_OUT_FILE, index=False)
    return True
...
def proc_fips_msa():
    ...
    msa_df.to_csv(FIPS_MSA_OUT_FILE, index=False)
    return True

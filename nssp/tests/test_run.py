...
from delphi_nssp.constants import GEOS, SIGNALS, CSV_COLS
...
def test_weighted_state_sum():
    ...
    agg = weighted_geo_sum(weighted, "geo_id", "b")
    ...
    weighted = generate_weights(dataFrame, column_aggregating="a")
    agg_a = weighted_geo_sum(weighted, "geo_id", "a")

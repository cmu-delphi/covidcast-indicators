...
aggs <- tribble(
  ...
  "pct_accept_cov_vaccine_1", "weight", "mc_accept_cov_vaccine", c("mc_race"), FALSE, compute_multiple_choice, I,
  "pct_accept_cov_vaccine_2", "weight", "mc_accept_cov_vaccine", c("mc_age"), FALSE, compute_multiple_choice, I,

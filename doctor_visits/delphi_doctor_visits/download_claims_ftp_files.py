...
# the time (e.g. EDI_AGG_OUTPATIENT_060620260000CDT.csv.gz) are both optional
FILENAME_TIMESTAMP = re.compile(r".*EDI_AGG_OUTPATIENT_(?:[0-9]_)?(?P<ymd>[0-9]{8})_?(?P<hm>[0-9]{4})[^0-9]*")
...
def change_date_format(name):
    ...
    EDI_AGG_OUTPATIENT_060620260000CDT.csv.gz. Downloaded files are always named
